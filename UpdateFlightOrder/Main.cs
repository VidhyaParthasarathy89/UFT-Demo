/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘UpdateFlightOrder.st’ 
    *  in HP Service Test.
     ***************************************************************/
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><UpdateFlightOrder xmlns=""HP.SOAQ.SampleApp""><UpdateFlightOrderDetails><Class>Economy</Class><CustomerName>Vid</CustomerName><NumberOfTickets>5</NumberOfTickets><OrderNumber>89</OrderNumber></UpdateFlightOrderDetails></UpdateFlightOrder></Body></Envelope>");
            ...
            _flow.StServiceCallActivity4.Name = @"UpdateFlightOrder";
            ...
            _flow.StServiceCallActivity4.TransportProtocol.SOAPProperties.SoapAction = @"HP.SOAQ.SampleApp/IFlightsSoapService/UpdateFlightOrder";
            ...
            _flow.StServiceCallActivity4.Operation = @"UpdateFlightOrder";
